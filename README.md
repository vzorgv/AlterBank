...
|                        |Нагрузочное тестирование. Перевод с\на одной и той же пары счетов 1, при исходной сумме баланса 1000. при 500 конкурирующих пользователях в течении 60 минут. Т.е. в каждый момент, времени каждый поток делает перевод 1 на ту же самую пару счетов в одном направлении, что и соседний поток|Вся сумма переведена с одного счета на другой. % ошибок 0%. Средний throughput при постоянной загрузке >=100. Ответ 200. После обнуления счета источника остатки на счетах и признак успешности перевода false Проверка корректности по сумме по завершении теста.|
