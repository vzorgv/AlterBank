...
|                        |Нагрузочное тестирование. Перевод с\на одной и той же пары счетов |За период времени 600 секунд необходимо сделать перевод 60000. 100 конкурентных пользователей делают перевод 1. По завершении 600 секундного интервала теста вся сумма должна быть переведена|
